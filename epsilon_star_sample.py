...
def sample_epsilon_star(sample_num, save_np_path):
    # train_path = '/mnt/store/lyx/github_projs/why/DDPM/epsilon_star/cifar_5k/cifar_5k_png'  # path to train set
    train_path = '/mnt/store/lyx/github_projs/why/DDPM/epsilon_star/cifar_5k/cifar_subset_5k.npy'
    # batch_data_path = ''
    # batch_data = np.load(batch_data_path)
    # train_batch_size, channels, image_size, _ = batch_data.shape
    image_size = 32
    channels = 3

    diffusion_star = DiffusionStar(
    ...
    for _ in range(sample_num):
        gen = diffusion_star.sample(batch_size=256)
        samples.append(gen)
    ...
    # save
    np.save(save_np_path, samples.cpu().detach().numpy())
...
if __name__ == '__main__':
    # save_np_path = 'eps_star_gen_256.npy'
    # sample_epsilon_star(sample_num=1, save_np_path=save_np_path)
    main()